...
public class Homework20 extends BaseTest {
    ...
    public void deletePlaylist() {
        String expectedDeletedPlaylistMessage = "Deleted playlist \"Playlist Homework20.\"";
    ...
    public void findPlaylist() {
        WebElement playlistName = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='playlists'] //a[contains(text(),'Playlist Homework20')]")));
        playlistName.click();
